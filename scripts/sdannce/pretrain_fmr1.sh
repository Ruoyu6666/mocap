...
###########################################
 --sliding_window 10 is better? longer 30 for example, worse? 
 - frame level very slightly worse, seqeuence level seems like too, with 10 it can reach 78% even, with 30 it seems a bit hard, maybe like 2% difference
